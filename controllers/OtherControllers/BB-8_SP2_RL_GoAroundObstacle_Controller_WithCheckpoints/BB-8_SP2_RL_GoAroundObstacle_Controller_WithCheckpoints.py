...
class BB8Robot_GoFAST(RobotSupervisorEnv):
    def __init__(self):
        ...
        self.observation_space = Box(low=np.array([-4, -6,-1, -1, -1, -math.pi]+self.check_point_list_min),
                                     high=np.array([4, 6, 1, 1, 1, math.pi]+self.check_point_list_max),
                                     dtype=np.float64)
    ...
    def get_observations(self):
        ...
        obs = [x,y,xAng,yAng,zAng,Angle] + chkPts
        return obs
    ...
    def solved(self):
        if len(self.episode_score_list) > 200:  # Over 100 trials thus far
            ...
            if np.mean(self.episode_score_list[-200:]) > 0.99:  # Last 100 episodes' scores average value
...
#agent.load("C:\\Users\\mcgra\\OneDrive\\Documents\\CourseMaterials\\DMU\\FinalProject\\BB-8_Stunts\\SP2_Agents\\sp2_GoAroundObstacle03")
...
while not solved and episode_count < episode_limit:
    ...
    if episode_count % 1000 == 0:    
        ...
        agent.save("C:\\Users\\mcgra\\OneDrive\\Documents\\CourseMaterials\\DMU\\FinalProject\\BB-8_Stunts\\SP2_Agents\\sp2_GoAroundObstacle04")
